...
const TOPIC_QUESTION_IDS: Record<string, number[]> = {
  // "Первая помощь"
  firstAid: [
    11, 17, 24, 29, 33, 38, 40, 43, 47, 52, 56, 63, 70, 75, 77, 83
  ],
  // "Пожарная безопасность"
  fireSafety: [
    1, 5, 7, 13, 19, 21, 35, 45, 48, 58
  ],
  // "ДТП, АСР"
  roadRescue: [
    12, 18, 25, 30, 34, 39, 44, 53, 61, 67, 69, 71, 73, 76, 84
  ],
  // "Работа с инструментом"
  tools: [
    4, 10, 16, 23, 28, 32, 42, 46, 51, 55, 60, 62, 66, 68, 72, 78, 80, 81, 82
  ],
  // "Психология"
  psychology: [
    3, 9, 15, 27, 31, 37, 41, 50, 54, 59, 64, 74, 79
  ],
  // "СИЗ и АХОВ"
  ppeAndAhov: [
